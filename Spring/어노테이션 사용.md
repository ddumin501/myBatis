...
```mermaid
graph LR
A[Component] --> B(Service[Service])
A --> C(Repository[DAO])
B --> D(Controller)
C --> D
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTE1NjkxNDQwLDE3OTc2NjkzMTQsLTE2Mz
A2MTU5MTQsMTMwMTU3MzUwOCwxMjQ2ODg0ODkxLDgyMDMyOTQy
LC04ODAxNDg3NTAsLTEyNzYzNzk2NTAsLTE0NzAxMTMyMjksLT
E2Mzc3NTc0NjEsMTI2NzA4MDc4OSwxNDU1MTQ3MjI4LDIxMzcy
NTMzNjBdfQ==
-->