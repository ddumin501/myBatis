...
```mermaid
graph LR
A[Component] --> B(Round Rect)
A --> C(Round Rect)
B --> D{Rhombus}
C --> D
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODIyNTgwMzgsMTc5NzY2OTMxNCwtMT
YzMDYxNTkxNCwxMzAxNTczNTA4LDEyNDY4ODQ4OTEsODIwMzI5
NDIsLTg4MDE0ODc1MCwtMTI3NjM3OTY1MCwtMTQ3MDExMzIyOS
wtMTYzNzc1NzQ2MSwxMjY3MDgwNzg5LDE0NTUxNDcyMjgsMjEz
NzI1MzM2MF19
-->