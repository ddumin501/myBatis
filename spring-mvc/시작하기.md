...
namespace 중에 beans, mvc 선택
6. ```<mvc:annotation-driven></mvc:annotation-driven>``` 추가
7. class 파일 생성 후 servlet 요청 실행, test
```java
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxOTc4NjA1OSwtNTYyMTMwMDE1LC0yND
kzODYwMTgsMTQ3OTA1NTE3OSwtMjM3MDQzOTddfQ==
-->